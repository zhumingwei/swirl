...
package com.zhumingwei.swirl.util;
...
import com.zhumingwei.library.GPUImage3x3ConvolutionFilter;
import com.zhumingwei.library.GPUImage3x3TextureSamplingFilter;
import com.zhumingwei.library.GPUImageAddBlendFilter;
import com.zhumingwei.library.GPUImageAlphaBlendFilter;
import com.zhumingwei.library.GPUImageBilateralFilter;
import com.zhumingwei.library.GPUImageBoxBlurFilter;
import com.zhumingwei.library.GPUImageBrightnessFilter;
import com.zhumingwei.library.GPUImageBulgeDistortionFilter;
import com.zhumingwei.library.GPUImageCGAColorspaceFilter;
import com.zhumingwei.library.GPUImageChromaKeyBlendFilter;
import com.zhumingwei.library.GPUImageColorBalanceFilter;
import com.zhumingwei.library.GPUImageColorBlendFilter;
import com.zhumingwei.library.GPUImageColorBurnBlendFilter;
import com.zhumingwei.library.GPUImageColorDodgeBlendFilter;
import com.zhumingwei.library.GPUImageColorInvertFilter;
import com.zhumingwei.library.GPUImageContrastFilter;
import com.zhumingwei.library.GPUImageCrosshatchFilter;
import com.zhumingwei.library.GPUImageDarkenBlendFilter;
import com.zhumingwei.library.GPUImageDifferenceBlendFilter;
import com.zhumingwei.library.GPUImageDilationFilter;
import com.zhumingwei.library.GPUImageDirectionalSobelEdgeDetectionFilter;
import com.zhumingwei.library.GPUImageDissolveBlendFilter;
import com.zhumingwei.library.GPUImageDivideBlendFilter;
import com.zhumingwei.library.GPUImageEmbossFilter;
import com.zhumingwei.library.GPUImageExclusionBlendFilter;
import com.zhumingwei.library.GPUImageExposureFilter;
import com.zhumingwei.library.GPUImageFalseColorFilter;
import com.zhumingwei.library.GPUImageFilter;
import com.zhumingwei.library.GPUImageFilterGroup;
import com.zhumingwei.library.GPUImageGammaFilter;
import com.zhumingwei.library.GPUImageGaussianBlurFilter;
import com.zhumingwei.library.GPUImageGlassSphereFilter;
import com.zhumingwei.library.GPUImageGrayscaleFilter;
import com.zhumingwei.library.GPUImageHalftoneFilter;
import com.zhumingwei.library.GPUImageHardLightBlendFilter;
import com.zhumingwei.library.GPUImageHazeFilter;
import com.zhumingwei.library.GPUImageHighlightShadowFilter;
import com.zhumingwei.library.GPUImageHueBlendFilter;
import com.zhumingwei.library.GPUImageHueFilter;
import com.zhumingwei.library.GPUImageKuwaharaFilter;
import com.zhumingwei.library.GPUImageLaplacianFilter;
import com.zhumingwei.library.GPUImageLevelsFilter;
import com.zhumingwei.library.GPUImageLightenBlendFilter;
import com.zhumingwei.library.GPUImageLinearBurnBlendFilter;
import com.zhumingwei.library.GPUImageLookupFilter;
import com.zhumingwei.library.GPUImageLuminosityBlendFilter;
import com.zhumingwei.library.GPUImageMonochromeFilter;
import com.zhumingwei.library.GPUImageMultiplyBlendFilter;
import com.zhumingwei.library.GPUImageNonMaximumSuppressionFilter;
import com.zhumingwei.library.GPUImageNormalBlendFilter;
import com.zhumingwei.library.GPUImageOpacityFilter;
import com.zhumingwei.library.GPUImageOverlayBlendFilter;
import com.zhumingwei.library.GPUImagePixelationFilter;
import com.zhumingwei.library.GPUImagePosterizeFilter;
import com.zhumingwei.library.GPUImageRGBDilationFilter;
import com.zhumingwei.library.GPUImageRGBFilter;
import com.zhumingwei.library.GPUImageSaturationBlendFilter;
import com.zhumingwei.library.GPUImageSaturationFilter;
import com.zhumingwei.library.GPUImageScreenBlendFilter;
import com.zhumingwei.library.GPUImageSepiaFilter;
import com.zhumingwei.library.GPUImageSharpenFilter;
import com.zhumingwei.library.GPUImageSketchFilter;
import com.zhumingwei.library.GPUImageSmoothToonFilter;
import com.zhumingwei.library.GPUImageSobelEdgeDetection;
import com.zhumingwei.library.GPUImageSoftLightBlendFilter;
import com.zhumingwei.library.GPUImageSourceOverBlendFilter;
import com.zhumingwei.library.GPUImageSphereRefractionFilter;
import com.zhumingwei.library.GPUImageSubtractBlendFilter;
import com.zhumingwei.library.GPUImageSwirlFilter;
import com.zhumingwei.library.GPUImageToneCurveFilter;
import com.zhumingwei.library.GPUImageToonFilter;
import com.zhumingwei.library.GPUImageTransformFilter;
import com.zhumingwei.library.GPUImageTwoInputFilter;
import com.zhumingwei.library.GPUImageVignetteFilter;
import com.zhumingwei.library.GPUImageWeakPixelInclusionFilter;
import com.zhumingwei.library.GPUImageWhiteBalanceFilter;
